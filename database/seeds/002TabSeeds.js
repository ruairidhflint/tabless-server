  ...
  return knex('tabs').del()
    .then(() => {
      return knex('tabs').insert([
       ...
       {id: 5, url:'https://www.elementsofai.com/', title:'', description:'', image:'', user_id: 1},
       {id: 6, url:'', title:'A free online introduction to artificial intelligence for non-experts', description:"Learn more about Reaktor's and the University of Helsinki's AI course - no programming or complicated math required.", image:'https://elementsofai.s3.amazonaws.com/_1200x600_crop_center-center_none/EOAIhero.png?mtime=20190314095435', user_id: 1},
       {id: 7, url:'https://www.vogue.co.uk/', title:'British Vogue - Fashion, Trends, Latest News, Catwalk Photos & Designers', description:'The global magazine for fashion trends, the lastest news, catwalk photos and more.', image:'https://www.vogue.co.uk/images/brands/vogue/meta-site-image.jpg', user_id: 1},
       {id: 8, url:'https://twitter.com/MrRoryFlint', title:'Rory Flint (@MrRoryFlint) | Twitter', description:'The latest Tweets from Rory Flint (@MrRoryFlint). Recovering Cynic. Full time Optimist nowadays. Passionate about Zen, Taoism and the Stoicism. Team Lead at Lambda School (WEBEU3). London, England', image:'https://pbs.twimg.com/profile_images/1115691068614434816/KhK1BZC2_400x400.png', user_id: 2},
       {id: 9, url:'https://www.esquire.com/uk/', title:"Esquire - Men's Style, Culture, Design", description:"The smart man's guide to the best in men's fashion, restaurants, accessories and tech - from classic watches to suits, we've got it covered", image:'http://www.esquire.com/sites/esquire/assets/images/logos/ipso_regulated_hires.png', user_id: 2},
      ]);
    });
};
